...
```{r, out.width = "250px",echo=F, fig.cap="The author during his third year of graduate school"}
...
In Pennsylvania, I joined the laboratory of Manuel Llinás where I worked on *Plasmodium* genomics. So what is a genome? You might recognize that genome contains the word "gen" which is short for gene. A genome is basically a collection of genes. Every living thing on planet Earth has its own genome, or its own collection of genes that make it unique. Understanding what these genes inside the genome do can help scientists design a cure for Malaria. So how do they do that?
